...
import kompas_3d_wrapper as k3d

LDefin2D, miscHelpers = k3d.import_ldefin2d_mischelpers()

#  Подключим константы API Компас
kompas6_constants = k3d.get_kompas_constants()

kompas6_api5_module, kompas_object = k3d.get_kompas_api5()

miscHelpers.iKompasObject = kompas_object

#  Подключим описание интерфейсов API7
kompas_api7_module, api7 = k3d.get_kompas_api7()

application = api7.Application
